...
module.exports.handler = async (event, context) => {
  ...
  let text = `Привет! Замечательно, что ты стремишься сделать свой день более продуктивным! Этот навык создан, чтобы поддерживать тебя и вдохновлять каждый день. Если у тебя есть предложения по его улучшению, не стесняйся делиться своим мнением в отзывах! Для начала работы навыка скажите "Начать". Следующую мотивационную звукозапись вы сможете прослушать завтра!`; // Начальный текст

  let tts =
    "Привет! Замечательно, что ты стремишься сделать свой день более продуктивным! Этот навык создан, чтобы поддерживать тебя и вдохновлять каждый день. Если у тебя есть предложения по его улучшению, не стесняйся делиться своим мнением в отзывах! Для начала работы навыка скажите Начать. Следующую мотивационную звукозапись вы сможете прослушать завтра!";
